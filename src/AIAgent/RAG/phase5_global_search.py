...
1. 评估该社区内容与用户问题的相关度（0-100 分），请严格按照以下标准打分，拉开评分差距（避免盲目打 85 分）：
   - 90 - 100 分：【核心直接相关】社区摘要直接探讨了问题核心，能为回答问题提供主体内容
   - 70 - 89 分：【重要支撑相关】社区摘要提供了重要的背景技术、实现组件或互补信息
   - 40 - 69 分：【边缘间接相关】社区摘要仅微弱涉及或属于一般性基础设施
   - 0 - 39 分：【不相关】社区摘要与用户问题的核心关注点完全无关
2. 如果相关度 >= 40，根据社区内容生成一段针对用户问题的部分回答；如果低于 40 或完全无关，partial_answer 设为空字符串 ""
